...
if __name__ == '__main__':
    ...
    #regr = DecisionTreeRegressor(max_depth=DT_MAX_DEPTH)
    regr = KNeighborsRegressor(n_neighbors=KNN_NEIGHBORS)
    ...
    for sample in load_dataset(test_path):
        ...
        predicted = regr.predict(trip[-1])[0]

        print('"{}",{},{}'.format(sample.trip_id, predicted[1], predicted[0]))
